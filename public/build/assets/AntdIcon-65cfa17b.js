import{aE as p,aF as er,aG as nr,aH as k,aI as tr,a as E}from"./app-04d7fd67.js";var v=2,$=.16,or=.05,ar=.05,ir=.15,V=5,G=4,lr=[{index:7,opacity:.15},{index:6,opacity:.25},{index:5,opacity:.3},{index:5,opacity:.45},{index:5,opacity:.65},{index:5,opacity:.85},{index:4,opacity:.9},{index:3,opacity:.95},{index:2,opacity:.97},{index:1,opacity:.98}];function F(r){var e=r.r,n=r.g,t=r.b,o=er(e,n,t);return{h:o.h*360,s:o.s,v:o.v}}function C(r){var e=r.r,n=r.g,t=r.b;return"#".concat(nr(e,n,t,!1))}function cr(r,e,n){var t=n/100,o={r:(e.r-r.r)*t+r.r,g:(e.g-r.g)*t+r.g,b:(e.b-r.b)*t+r.b};return o}function B(r,e,n){var t;return Math.round(r.h)>=60&&Math.round(r.h)<=240?t=n?Math.round(r.h)-v*e:Math.round(r.h)+v*e:t=n?Math.round(r.h)+v*e:Math.round(r.h)-v*e,t<0?t+=360:t>=360&&(t-=360),t}function D(r,e,n){if(r.h===0&&r.s===0)return r.s;var t;return n?t=r.s-$*e:e===G?t=r.s+$:t=r.s+or*e,t>1&&(t=1),n&&e===V&&t>.1&&(t=.1),t<.06&&(t=.06),Number(t.toFixed(2))}function M(r,e,n){var t;return n?t=r.v+ar*e:t=r.v-ir*e,t>1&&(t=1),Number(t.toFixed(2))}function j(r){for(var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=[],t=p(r),o=V;o>0;o-=1){var a=F(t),l=C(p({h:B(a,o,!0),s:D(a,o,!0),v:M(a,o,!0)}));n.push(l)}n.push(C(t));for(var i=1;i<=G;i+=1){var c=F(t),u=C(p({h:B(c,i),s:D(c,i),v:M(c,i)}));n.push(u)}return e.theme==="dark"?lr.map(function(m){var g=m.index,b=m.opacity,O=C(cr(p(e.backgroundColor||"#141414"),p(n[g]),b*100));return O}):n}var T={red:"#F5222D",volcano:"#FA541C",orange:"#FA8C16",gold:"#FAAD14",yellow:"#FADB14",lime:"#A0D911",green:"#52C41A",cyan:"#13C2C2",blue:"#1890FF",geekblue:"#2F54EB",purple:"#722ED1",magenta:"#EB2F96",grey:"#666666"},S={},x={};Object.keys(T).forEach(function(r){S[r]=j(T[r]),S[r].primary=S[r][5],x[r]=j(T[r],{theme:"dark",backgroundColor:"#141414"}),x[r].primary=x[r][5]});var H=[],d=[],ur="insert-css: You need to provide a CSS string. Usage: insertCss(cssString[, options]).";function sr(){var r=document.createElement("style");return r.setAttribute("type","text/css"),r}function fr(r,e){if(e=e||{},r===void 0)throw new Error(ur);var n=e.prepend===!0?"prepend":"append",t=e.container!==void 0?e.container:document.querySelector("head"),o=H.indexOf(t);o===-1&&(o=H.push(t)-1,d[o]={});var a;return d[o]!==void 0&&d[o][n]!==void 0?a=d[o][n]:(a=d[o][n]=sr(),n==="prepend"?t.insertBefore(a,t.childNodes[0]):t.appendChild(a)),r.charCodeAt(0)===65279&&(r=r.substr(1,r.length)),a.styleSheet?a.styleSheet.cssText+=r:a.textContent+=r,a}function z(r){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?Object(arguments[e]):{},t=Object.keys(n);typeof Object.getOwnPropertySymbols=="function"&&(t=t.concat(Object.getOwnPropertySymbols(n).filter(function(o){return Object.getOwnPropertyDescriptor(n,o).enumerable}))),t.forEach(function(o){pr(r,o,n[o])})}return r}function pr(r,e,n){return e in r?Object.defineProperty(r,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):r[e]=n,r}function N(r){return typeof r=="object"&&typeof r.name=="string"&&typeof r.theme=="string"&&(typeof r.icon=="object"||typeof r.icon=="function")}function A(r,e,n){return n?k(r.tag,z({key:e},n,r.attrs),(r.children||[]).map(function(t,o){return A(t,"".concat(e,"-").concat(r.tag,"-").concat(o))})):k(r.tag,z({key:e},r.attrs),(r.children||[]).map(function(t,o){return A(t,"".concat(e,"-").concat(r.tag,"-").concat(o))}))}function q(r){return j(r)[0]}function Y(r){return r?Array.isArray(r)?r:[r]:[]}var dr=`
.anticon {
