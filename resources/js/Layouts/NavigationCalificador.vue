    ...
    <nav class="sidebar-gradient-nav">
      <div class="nav-section">
        ...
        <ul class="nav-gradient-menu">
          ...
          <li class="nav-gradient-item" :class="{ 'nav-gradient-active': route().current('calificar-lecturas') }">
            <NavLink :href="route('calificar-lecturas')" :active="route().current('calificar-lecturas')" class="nav-gradient-link">
              <div class="nav-content-wrapper">
                <div class="nav-gradient-icon">
                  <div class="icon-bg"></div>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                ...
                <span class="nav-gradient-text">Carga de Lecturas</span>
              </div>
              <div class="nav-highlight"></div>
            </NavLink>
          </li>
