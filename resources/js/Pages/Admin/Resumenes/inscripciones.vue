...
<div class=" mt-4 overflow-hidden shadow-sm sm:rounded-lg p-4" style="height: calc(100vh - 230px); background: var(--card-bg, #ffffff); border: 1px solid var(--card-border, #e2e8f0); color: var(--card-text, #1e293b);">
