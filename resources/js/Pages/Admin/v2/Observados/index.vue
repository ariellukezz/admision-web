...
<div class="">
  <div class="mb-4">
      <span class="text-xl font-bold" style="color: var(--card-text, #1e293b);">Gestión de Observados</span>
  </div>
...
<div style="background: var(--card-bg, #ffffff); border: 1px solid var(--card-border, #e2e8f0); border-radius: 8px; padding: 8px;">
  <a-table
