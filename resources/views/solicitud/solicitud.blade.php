                        ...
                        <div style="padding-left:20px; margin-top: 14px;">
                          ...
                          @else
                            <table>
                              ...
                              <tr><td v-align="top"><div style="margin-top:-20px;">4.</div></td><td style="height: 23px;">Otros requisitos según lo estipulado en el Art. 15 del Reglamento General de admisión 2026 conforme a la modalidad de postulación.</td></tr>
                          </table>
                          @endif
                        </div>
