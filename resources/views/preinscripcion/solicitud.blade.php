...
<body style="font-family: 'Gill Sans Extrabold', Helvetica, sans-serif; *{margin:0;padding:0}" >
    <div style="">
        ...
        <div style="margin-top: 10px; margin-bottom:20px">  
            <table style="width: 100%">
                <tr>
                    <td align="center"><div style="text-align: center"><span style="font-size:14pt; font-weight:bold">HOJA DE PRE - INSCRIPCIÓN</span></div></td>
                </tr>
                <tr>
                    <td align="center"><div style="text-align: center"><span style="font-size:14pt; font-weight:bold">EXAMEN GENERAL 2023-I</span></div></td>
                </tr>
                {{-- <tr>
            ...
            <table style="font-size:11pt; font-weight:bold; width:100%;">
                ...
                <tr style="margin-bottom:-12px;">
                    ...
                    <td align="left" valign="top">
                        <div style="text-align: justify; font-weight: regular; margin-top: -6px;">
                            <span style="text-transform: uppercase;"> INGENIERIA DE SISTEMAS</span>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" valign="top"><div style="text-align: justify; font-weight: regular; margin-top: -6px;"><span style="text-transform: uppercase;">70757838</span></div></td>
                </tr>
                <tr>
                    ...
                    <td align="left" valign="top"><div style="text-align: justify; font-weight: regular; margin-top: -6px;"><span style="text-transform: uppercase;">LUQUE</span></div></td>
                </tr>
                <tr>
                    ...
                    <td align="left" valign="top"><div style="text-align: justify; font-weight: regular; margin-top: -6px;"><span style="text-transform: uppercase;"> CUSACANI </span></div></td>
                </tr>
                <tr>
                    ...
                    <td align="left" valign="top"><div style="text-align: justify; font-weight: regular; margin-top: -30px;"><span style="text-transform: capitalize;">JHON ARIEL</span></div></td>
                </tr>
                <tr>
                    ...
                    <td align="left" valign="top"><div style="text-align: justify; font-weight: regular; margin-top: -36px;"><span style="text-transform: capitalize;">01-02-23</span></div></td>
                </tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: justify;">
                            <p style="line height:160%;">
                                ...
                                dispuesto en el reglamento del <span style="font-weight:bold;">EXAMEN DE ADMISIÓN GENERAL 2023 - I,</span>
                                del mismo modo me comprometo en apersonarme a la oficina de Dirección de Admisión 
                                para la inscripción presencial 
                                según cuyo último digito de DNI corresponda.
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="margin-top:0px">
                    ...
                    <td style="" valign="top">
                        <div>
                            ...
                            <div style="margin-top: 16px">
                                ...
                                <div><span>- </span><span>Hoja de Pre-inscripcion</span></div>
            ...
            <table style="width:100%; bakcground:orange; margin-top:40px">
                <tr>
                    <td align="right"> 
                        <span style="font-size:8pt;"><?php echo DNS1D::getBarcodeHTML("70757838",'C128');?> </span>
                    </td> 
                </tr>
                <tr>                    
                    <td>
